# CortexEdge — Agentic AI Certificate

Deploy to: https://cortexelearn.github.io/agentic-ai/  (repo name: agentic-ai)
...
Includes the exam phase-normalization fix. Cache: cortexedge-agentic-ai-v3.

## Deploy / redeploy
1. Repo named exactly: agentic-ai
